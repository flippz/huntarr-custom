"""Huntarr v2 application factory.
...
def create_app(config: dict | None = None) -> Flask:
    ...
    db_path = app.config.get("DB_PATH", "data-v2/huntarr_v2.db")
    db = Database(db_path)
    db.init_schema()
    ...
    @app.get("/health")
    def health():
        result = app.extensions["huntarr"]["status"].health()
