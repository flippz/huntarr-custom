...
Huntarr v2's search/grab/import cycle.
...
class AutomationPolicy:
    ...
    def summary(self) -> str:
        ...
        return (
            ...
            f"{self.successful_grab_target} successful grab(s) per cycle, "
            f"dispatching new searches every {self.dispatch_interval_seconds} "
            f"second(s) while keeping the queue at up to {self.queue_target} "
