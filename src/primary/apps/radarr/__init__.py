    ...
    if "instances" in settings and isinstance(settings["instances"], list) and settings["instances"]:
        for idx, instance in enumerate(settings["instances"]):
            if instance.get("enabled", True) and instance.get("api_url") and instance.get("api_key"):
                ...
                instance_settings["state_management_hours"] = instance.get("state_management_hours", 24)
                ...
                instance_settings["target_queue_depth"] = instance.get("target_queue_depth", 3)
                instance_settings["minimum_dispatch_interval_seconds"] = instance.get("minimum_dispatch_interval_seconds", 15)
                instance_settings["queue_redispatch_wait_seconds"] = instance.get("queue_redispatch_wait_seconds", 60)
                instance_settings["webhook_enabled"] = instance.get("webhook_enabled", False)
                instance_settings["shared_capacity_weight"] = instance.get("shared_capacity_weight", 1)
                instance_settings["decypharr_capacity_enabled"] = instance.get("decypharr_capacity_enabled", False)
                instance_settings["decypharr_max_active_jobs"] = instance.get("decypharr_max_active_jobs", 0)
        ...
        if not is_enabled:
            ...
            settings_copy["state_management_hours"] = settings.get("state_management_hours", 24)
            ...
            settings_copy["target_queue_depth"] = settings.get("target_queue_depth", 3)
            settings_copy["minimum_dispatch_interval_seconds"] = settings.get("minimum_dispatch_interval_seconds", 15)
            settings_copy["queue_redispatch_wait_seconds"] = settings.get("queue_redispatch_wait_seconds", 60)
            settings_copy["webhook_enabled"] = settings.get("webhook_enabled", False)
            settings_copy["shared_capacity_weight"] = settings.get("shared_capacity_weight", 1)
            settings_copy["decypharr_capacity_enabled"] = settings.get("decypharr_capacity_enabled", False)
            settings_copy["decypharr_max_active_jobs"] = settings.get("decypharr_max_active_jobs", 0)
