...
from src.primary.utils.db_mixins.db_magnetarr import MagnetarrMixin

__all__ = ['ConfigMixin', 'StateMixin', 'UsersMixin', 'RequestarrMixin', 'ExtrasMixin', 'MagnetarrMixin']
